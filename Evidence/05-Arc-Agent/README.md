...
|---|---|---|---|
| **01. Local Arc Agent Status** | `ENTRA-SYNC01` | [azcmagent-status-show](./azcmagent-status-show.txt) | Executed `azcmagent.exe show`; confirmed `Agent Status: Connected` and core services (`himds`, `ExtensionService`) running. |
