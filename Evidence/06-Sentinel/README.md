...
| **05. Incident Generation & Triage** | Microsoft Sentinel | [sentinel-incident-triage-evidence](./sentinel-incident-triage-evidence.jpg) | Verified automated generation of Incident `INC-1001`; mapped MITRE ATT&CK tactics (Persistence, Privilege Escalation) and entity extraction. |
