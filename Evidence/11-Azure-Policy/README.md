...
| **3. Preventative Enforcement (Negative Test)** | Azure CLI | [policy-violation-error.txt](./policy-violation-error.txt) | Deployment of `nic-policy-violation-test` terminated with error `RequestDisallowedByPolicy`. |
