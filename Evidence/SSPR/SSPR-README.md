...
| **2. Handshake** | `ENTRA-SYNC01` | `sync-server-events.txt` | Event ID `31001` (`PasswordResetRequestStart`) at `10:21:09 AM` |
| **3. Execution** | `ENTRA-SYNC01` | `sync-server-events.txt` | Event ID `31002` (`PasswordResetSuccess`) at `10:21:09 AM` |
| **4. Finality** | `DC01` | `dc01-pwdlastset-proof.txt` | `pwdLastSet` updated to `10:28:19 AM` |
