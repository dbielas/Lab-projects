...
| **03. Connected Machines Verification** | Azure | [arc-connected-machines](./arc-connected-machines.txt) | Executed `az connectedmachine list` query; confirmed both `DC01` and `ENTRA-SYNC01` connected to Azure. |
